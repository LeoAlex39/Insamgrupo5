...
class DocenteController {
    ...
    public function __construct() { $this->model = new Docente(); }
    ...
    public function index() {
        ...
        include VIEW_PATH . '/docente/index.php';
    }
    ...
    public function crear() {
        ...
        include VIEW_PATH . '/docente/crear.php';
    }
    ...
    public function editar() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $pwd = null;
            if ($pass1 !== '' || $pass2 !== '') {
                if ($pass1 !== $pass2) { $error = "Las contraseñas no coinciden."; include VIEW_PATH . '/docente/editar.php'; return; }
                $pwd = $pass1;
            }
        ...
        include VIEW_PATH . '/docente/editar.php';
    }
    ...
    public function eliminar() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                include VIEW_PATH . '/docente/eliminar.php';
                return;
            }
        } else {
            include VIEW_PATH . '/docente/eliminar.php';
